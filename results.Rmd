...
On the other hand the return is less correlated, this could de linked to the magnitude in change of prices. These stocks spike and dip at the same time but at different magnitude, this could explain the lower correlation of the return.
...
#Problem of the order of the months to fix 
